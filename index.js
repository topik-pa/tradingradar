...
// Set CORS
const allowlist = ['http://localhost:8081', 'https://tradingradar-v3-gui-staging.herokuapp.com', 'https://tradingradar-v3-gui.herokuapp.com', 'https://www.tradingradar.net']
var corsOptions = {
  origin: allowlist,
  credentials:  true
}
